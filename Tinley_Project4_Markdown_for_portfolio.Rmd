...
The dataset I selected for the Module 4 project is data about hospital admissions for patients with diabetes at 130 different hospitals called, “Diabetes 130-US Hospitals for Years 1999-2008Links to an external site.” from the UC Irvine Machine Learning Repository. This is a rich dataset with 50 columns about the patient and their hospital stay.
...
NEJM Catalyst. (2018). Hospital Readmissions Reduction Program (HRRP). Catalyst Carryover, 4(2). <https://doi.org/10.1056/CAT.18.0194>
...
Wickham, H., François, R., Henry, L., & Müller, K. (2023). dplyr: A grammar of data manipulation (R package version 1.1.3) [Software]. <https://CRAN.R-project.org/package=dplyr>
...
Ripley, B., & Venables, W. (2024). nnet: Feed-forward neural networks and multinomial log-linear models (R package version 7.3-19) [Software]. <https://CRAN.R-project.org/package=nnet>
